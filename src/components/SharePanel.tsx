    ...
    <div className="bg-black border-2 border-green-500 rounded-lg p-6 shadow-2xl shadow-green-500/50 max-w-md w-full animate-slideUp">
      ...
      <div className="space-y-4">
        <div className="bg-green-950/30 border border-green-700 rounded p-4">
          ...
          <p className="text-green-300 font-mono text-sm break-all mb-3">{email}</p>
          <button
            onClick={copyEmail}
            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-green-900/30 hover:bg-green-900/50 border border-green-500 rounded text-green-400 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/50 font-mono text-sm"
          >
            {copied ? (
              <>
                <Check size={18} />
        ...
        <div className="bg-green-950/30 border border-green-700 rounded p-3 mt-4">
