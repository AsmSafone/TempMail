        ...
        <div className="space-y-6">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <label className="text-green-400 font-mono text-sm">Auto-refresh Interval</label>
            </div>
            <div className="space-y-2">
              {intervalOptions.map((option) => (
                <button
                  ...
                  className={`w-full px-4 py-2 border rounded font-mono text-sm transition-all duration-300 ${
            ...
            <div className="mt-3 bg-green-950/30 border border-green-700 rounded p-3">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <label className="text-green-400 font-mono text-sm">Browser Notifications</label>
            </div>
